...
mysql_query("INSERT INTO history (date,action,data) VALUES (NOW(),'Add User','$user')")or die(mysql_error());
						
						{
						mysql_query ("INSERT INTO user (firstname,middlename,lastname,username,password,user_added)
						 VALUES ('$firstname','$middlename','$lastname','$username','$password',NOW())")or die(mysql_error());
						}
